 ...
 * </p>
 * <ul>
 *   <li>{@link excel2BPMN.impl.ExcelImpl#getTable <em>Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcelImpl extends MinimalEObjectImpl.Container implements Excel {
	...
	protected EClass eStaticClass() {
		return Excel2BPMNPackage.Literals.EXCEL;
	}
	...
	public EList<Table> getTable() {
		if (table == null) {
			table = new EObjectContainmentEList<Table>(Table.class, this, Excel2BPMNPackage.EXCEL__TABLE);
		}
		return table;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Excel2BPMNPackage.EXCEL__TABLE:
